        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="text-muted">Otomatis terisi dari user login, boleh diubah.</small>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="image" class="form-control" placeholder="URL Gambar (opsional)" value="{{ old('image') }}">
                        </div>
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="image_file">Upload gambar...</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <img src="{{ old('author_avatar', 'https://www.gravatar.com/avatar/' . md5(strtolower(trim(auth()->user()->email))) . '?d=mp&s=100') }}" class="rounded-circle mr-2" style="width: 40px; height: 40px; object-fit: cover;" id="avatar_preview">
                            <span class="text-muted">Avatar otomatis dari user login</span>
                        </div>
                        <div class="input-group mb-2">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user-circle"></i></span>
                            </div>
                            <input type="text" name="author_avatar" class="form-control" placeholder="URL Avatar (opsional)" value="{{ old('author_avatar') }}">
                        </div>
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="author_avatar_file">Upload avatar...</label>
            ...
            <div class="form-group">
                <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label" for="is_published">Publish Sekarang</label>
                </div>
            </div>
        </div>
