    ...
    <div class="container">
        <div style="max-width: 720px; margin: 0 auto;">
            ...
            <div style="background: white; border-radius: 16px; padding: 30px;">
                <h3 style="font-size: 18px; font-weight: 700; margin-bottom: 24px;">Form Konfirmasi</h3>
                <form action="{{ route('payment-confirmation.store', $order) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div style="margin-bottom: 18px;">
                        <label style="display: block; font-size: 14px; font-weight: 500; margin-bottom: 8px;">Nama Pengirim *</label>
                    ...
                    <div class="grid-2-col" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 18px;">
                        <div>
                            <label style="display: block; font-size: 14px; font-weight: 500; margin-bottom: 8px;">Jumlah Transfer *</label>
                        ...
                        <div>
                            <label style="display: block; font-size: 14px; font-weight: 500; margin-bottom: 8px;">Tanggal Transfer *</label>
                    ...
                    <div style="margin-bottom: 24px;">
                        <label style="display: block; font-size: 14px; font-weight: 500; margin-bottom: 8px;">Bukti Transfer (opsional, max 2MB)</label>
